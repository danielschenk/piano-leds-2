 ...
 */
class RtMidiMidiInput : public BaseMidiInput
{
  public:
    /**
     * Constructor.
  ...
  private:
    ...
    static void RtMidiCommonCallback(double deltatime, std::vector<unsigned char> *message,
                                     void *userData);

    /** The instance-specific callback function handling all RtMidi callbacks and delegating them to
     * subscribers. */
